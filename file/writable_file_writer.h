...
class WritableFileWriter {
 ...
 public:
  ...
  inline uint64_t GetUnflushedSize() const {
    if (GetFileSize() > GetFlushedSize()) {
      return GetFileSize() - GetFlushedSize();
    }
    return 0;
  }
  ...
  IOStatus GetIOCtx(SBCIOContex *io_ctx);

  IOStatus FinishIOCtx(SBCIOContex *io_ctx);
